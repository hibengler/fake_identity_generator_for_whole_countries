...
# check run PUB3
echo 1>&2  good_name_p8.txt run PUB3 `cat run`
...
# check run PUB4
echo 1>&2  good_name_p8.txt run PUB4 `cat run`
...
# check run PUB5
echo 1>&2  good_name_p8.txt run PUB5 `cat run`
...
# check run PUB6
echo 1>&2  good_name_p8.txt run PUB6 `cat run`
