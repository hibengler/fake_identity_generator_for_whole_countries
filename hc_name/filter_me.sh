...
# check run 001
echo 1>&2  good_name_p8 001.txt run `cat run`
...
# check run TST1
echo 1>&2  good_name_p8   TST1.txt run `cat run`
...
# check run PUB2
echo 1>&2  good_name_p8   PUB2.txt run `cat run`
...
# check run PUB3
echo 1>&2  good_name_p8   PUB3.txt run `cat run`
...
# check run PUB4
echo 1>&2  good_name_p8   PUB4.txt run `cat run`
...
# check run PUB5
echo 1>&2  good_name_p8   PUB5.txt run `cat run`
...
# check run PUB6
echo 1>&2  good_name_p8   PUB6.txt run `cat run`
