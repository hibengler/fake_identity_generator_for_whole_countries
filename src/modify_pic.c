...
/* right.  now draw some spooky text to spookify them */
	...
	d=t&255;
	sprintf(buf,"Fake");
	DrawAnnotation(d_wand,29,80,buf);	
	DrawAnnotation(d_wand,1840,80,buf);	
	DrawAnnotation(d_wand,29,387,buf);	
	DrawAnnotation(d_wand,1840,387,buf);	
	DrawAnnotation(d_wand,29,694,buf);	
	DrawAnnotation(d_wand,1840,694,buf);
	DrawAnnotation(d_wand,29,1080-80,buf);	
	DrawAnnotation(d_wand,1840,1080-80,buf);	
        }	
	...
	t = t >>8;
	d=t&255;
	sprintf(buf,"Fake U.S. Identities");
